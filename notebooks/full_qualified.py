...
def _(fully_classified, ground_truth_cat, prec_cat):
    ...
    prec2, coverage2 = prec_cat(ground_truth_cat[ground_truth_cat['query'].isin(impacted_queries2)],
                              'category', 'No Category Fits', fully_classified)
    prec2, coverage2
    return (impacted_queries2,)


@app.cell
def _(fully_classified, ground_truth_cat, impacted_queries2, prec_cat):
    prec3, coverage3 = prec_cat(ground_truth_cat[~ground_truth_cat['query'].isin(impacted_queries2)],
                              'category', 'No Category Fits', fully_classified)
    prec3, coverage3
    return
